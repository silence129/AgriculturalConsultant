...
public class LawsAdapter extends BaseAdapter {
    ...
    //数据
    private List<LawsListBean.ContentBean> mList;
     ...
     */
    public LawsAdapter(Context mContext, List<LawsListBean.ContentBean> mList) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        LawsListBean.ContentBean news = mList.get(i);
        ...
        Glide.with(mContext).load(news.getUrlPics()).placeholder(mContext.getResources().getDrawable(R.drawable.pic_default_all)).transform(new GlideRoundTransform(mContext, 5)).into(viewHolder.previewImageNews);
        viewHolder.titleNews.setText(news.getTitle());
        viewHolder.timeNews.setText(news.getCreattime());
